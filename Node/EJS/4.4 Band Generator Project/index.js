...
app.post("/submit", (req, res) => {
  ...
  var adjective = adj[Math.floor(Math.random() * adj.length)],
    bandNoun = noun[Math.floor(Math.random() * noun.length)];
  var capitalizedAdj =
    adjective.charAt(0).toLocaleUpperCase() + adjective.slice(1);
  var capitalizedNoun =
    bandNoun.charAt(0).toLocaleUpperCase() + bandNoun.slice(1);
  var bandName = `${capitalizedAdj} ${capitalizedNoun} `;
